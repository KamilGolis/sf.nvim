 ...
 function M.reset_module_state()
  ...
  -- Create fresh default options on the singleton (mini.test reuses the process,
  -- so Config:setup({}) by itself preserves previous paths via "keep" extend).
  local Config = require("sf.config")
  local fresh = Config:new()
  Config.options = fresh.options
  Config:setup({}) -- normalize paths with fresh defaults
 end
